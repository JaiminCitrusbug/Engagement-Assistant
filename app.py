...
st.set_page_config(page_title="Engagement Assistant", layout="centered")

st.title("📊 Engagement Assistant")
st.markdown("Chat with your AI engagement and campaign management assistant (RAG-powered).")
...
if prompt := st.chat_input("Type your question..."):
    ...
    with st.chat_message("assistant"):
        ...
        with st.spinner("Analyzing with engagement knowledge base..."):
